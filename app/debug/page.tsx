          ...
          <div className="animate-fade-in-up space-y-6">
            ...
            <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-secondary)] overflow-hidden">
              ...
              <div className="relative">
                <div className="flex">
                  <div className="flex-shrink-0 w-12 py-4 text-right pr-3 select-none">
              ...
              <div className="flex items-center justify-between px-4 py-1.5 bg-[var(--blue)]/10 border-t border-[var(--border-default)] text-[10px] font-mono text-[var(--text-tertiary)]">
